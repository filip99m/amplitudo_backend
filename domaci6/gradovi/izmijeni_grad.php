...
<body>
    ...
    <div class="text-center row mt-5">
            ...
            <div class="col-4">
                <h3>Izmijeni</h3>
                <form action="dodaj_novu_izmjenu_grada.php" class="form" method="POST">
                    <input class="form-control" type="hidden" name="id" value="<?=$id?>">
                    <input class="form-control" type="text" name="naziv_grada" placeholder="Unesi grad" value="<?=$grad['naziv_grada']?>">
